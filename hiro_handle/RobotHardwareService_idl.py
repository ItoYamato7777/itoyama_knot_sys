...
#
__name__ = "OpenHRP"
_0_OpenHRP = omniORB.openModule("OpenHRP", r"RobotHardwareService.idl")
_0_OpenHRP__POA = omniORB.openModule("OpenHRP__POA", r"RobotHardwareService.idl")


# interface RobotHardwareService
_0_OpenHRP._d_RobotHardwareService = (omniORB.tcInternal.tv_objref, "IDL:OpenHRP/RobotHardwareService:1.0", "RobotHardwareService")
omniORB.typeMapping["IDL:OpenHRP/RobotHardwareService:1.0"] = _0_OpenHRP._d_RobotHardwareService
_0_OpenHRP.RobotHardwareService = omniORB.newEmptyClass()
class RobotHardwareService :
    _NP_RepositoryId = _0_OpenHRP._d_RobotHardwareService[1]
    ...
    # typedef ... DblSequence
    class DblSequence:
        _NP_RepositoryId = "IDL:OpenHRP/RobotHardwareService/DblSequence:1.0"
        def __init__(self, *args, **kw):
            raise RuntimeError("Cannot construct objects of this type.")
    ...
    class LongSequence:
        _NP_RepositoryId = "IDL:OpenHRP/RobotHardwareService/LongSequence:1.0"
        def __init__(self, *args, **kw):
            raise RuntimeError("Cannot construct objects of this type.")
    ...
    # typedef ... StrSequence
    class StrSequence:
        _NP_RepositoryId = "IDL:OpenHRP/RobotHardwareService/StrSequence:1.0"
        def __init__(self, *args, **kw):
            raise RuntimeError("Cannot construct objects of this type.")
    ...
    # typedef ... DblArray3
    class DblArray3:
        _NP_RepositoryId = "IDL:OpenHRP/RobotHardwareService/DblArray3:1.0"
        def __init__(self, *args, **kw):
            raise RuntimeError("Cannot construct objects of this type.")
    ...
    # typedef ... DblArray6
    class DblArray6:
        _NP_RepositoryId = "IDL:OpenHRP/RobotHardwareService/DblArray6:1.0"
        def __init__(self, *args, **kw):
            raise RuntimeError("Cannot construct objects of this type.")
    ...
    class DblSequence3:
        _NP_RepositoryId = "IDL:OpenHRP/RobotHardwareService/DblSequence3:1.0"
        def __init__(self, *args, **kw):
            raise RuntimeError("Cannot construct objects of this type.")
    ...
    class DblSequence6:
        _NP_RepositoryId = "IDL:OpenHRP/RobotHardwareService/DblSequence6:1.0"
        def __init__(self, *args, **kw):
            raise RuntimeError("Cannot construct objects of this type.")
    ...
    # struct RobotState
    _0_OpenHRP.RobotHardwareService.RobotState = omniORB.newEmptyClass()
    class RobotState (omniORB.StructBase):
        _NP_RepositoryId = "IDL:OpenHRP/RobotHardwareService/RobotState:1.0"

        _NP_ClassName = "OpenHRP.RobotHardwareService.RobotState"
    ...
    _d_RobotState  = _0_OpenHRP.RobotHardwareService._d_RobotState = (omniORB.tcInternal.tv_struct, RobotState, RobotState._NP_RepositoryId, "RobotState", "angle", omniORB.typeMapping["IDL:OpenHRP/RobotHardwareService/DblSequence:1.0"], "command", omniORB.typeMapping["IDL:OpenHRP/RobotHardwareService/DblSequence:1.0"], "torque", omniORB.typeMapping["IDL:OpenHRP/RobotHardwareService/DblSequence:1.0"], "servoState", omniORB.typeMapping["IDL:OpenHRP/RobotHardwareService/LongSequence:1.0"], "force", (omniORB.tcInternal.tv_sequence, omniORB.typeMapping["IDL:OpenHRP/RobotHardwareService/DblSequence6:1.0"], 0), "rateGyro", (omniORB.tcInternal.tv_sequence, omniORB.typeMapping["IDL:OpenHRP/RobotHardwareService/DblSequence3:1.0"], 0), "accel", (omniORB.tcInternal.tv_sequence, omniORB.typeMapping["IDL:OpenHRP/RobotHardwareService/DblSequence3:1.0"], 0), "voltage", omniORB.tcInternal.tv_double, "current", omniORB.tcInternal.tv_double)
    ...
    SwitchStatus = omniORB.Enum("IDL:OpenHRP/RobotHardwareService/SwitchStatus:1.0", (SWITCH_ON, SWITCH_OFF,))
...
_0_OpenHRP.RobotHardwareService = RobotHardwareService
_0_OpenHRP._tc_RobotHardwareService = omniORB.tcInternal.createTypeCode(_0_OpenHRP._d_RobotHardwareService)
omniORB.registerType(RobotHardwareService._NP_RepositoryId, _0_OpenHRP._d_RobotHardwareService, _0_OpenHRP._tc_RobotHardwareService)

# RobotHardwareService operations and attributes
RobotHardwareService._d_getStatus = ((), (omniORB.typeMapping["IDL:OpenHRP/RobotHardwareService/RobotState:1.0"], ), None)
RobotHardwareService._d_power = (((omniORB.tcInternal.tv_string,0), omniORB.typeMapping["IDL:OpenHRP/RobotHardwareService/SwitchStatus:1.0"]), (omniORB.tcInternal.tv_boolean, ), None)
RobotHardwareService._d_servo = (((omniORB.tcInternal.tv_string,0), omniORB.typeMapping["IDL:OpenHRP/RobotHardwareService/SwitchStatus:1.0"]), (omniORB.tcInternal.tv_boolean, ), None)
...
RobotHardwareService._d_getJointPartNames = ((), (omniORB.tcInternal.tv_ulong, omniORB.typeMapping["IDL:OpenHRP/RobotHardwareService/StrSequence:1.0"]), None)
RobotHardwareService._d_getJointNamesInPart = (((omniORB.tcInternal.tv_string,0), ), (omniORB.tcInternal.tv_ulong, omniORB.typeMapping["IDL:OpenHRP/RobotHardwareService/StrSequence:1.0"]), None)
...
class _objref_RobotHardwareService (CORBA.Object):
    ...
    def getStatus(self, *args):
        return _omnipy.invoke(self, "getStatus", _0_OpenHRP.RobotHardwareService._d_getStatus, args)

    def power(self, *args):
        return _omnipy.invoke(self, "power", _0_OpenHRP.RobotHardwareService._d_power, args)

    def servo(self, *args):
        return _omnipy.invoke(self, "servo", _0_OpenHRP.RobotHardwareService._d_servo, args)

    def calibrateJoint(self, *args):
        return _omnipy.invoke(self, "calibrateJoint", _0_OpenHRP.RobotHardwareService._d_calibrateJoint, args)

    def calibrateSensor(self, *args):
        return _omnipy.invoke(self, "calibrateSensor", _0_OpenHRP.RobotHardwareService._d_calibrateSensor, args)

    def engageProtectiveStop(self, *args):
        return _omnipy.invoke(self, "engageProtectiveStop", _0_OpenHRP.RobotHardwareService._d_engageProtectiveStop, args)

    def disengageProtectiveStop(self, *args):
        return _omnipy.invoke(self, "disengageProtectiveStop", _0_OpenHRP.RobotHardwareService._d_disengageProtectiveStop, args)

    def getJointPartNames(self, *args):
        return _omnipy.invoke(self, "getJointPartNames", _0_OpenHRP.RobotHardwareService._d_getJointPartNames, args)

    def getJointNamesInPart(self, *args):
        return _omnipy.invoke(self, "getJointNamesInPart", _0_OpenHRP.RobotHardwareService._d_getJointNamesInPart, args)
...
_0_OpenHRP._objref_RobotHardwareService = _objref_RobotHardwareService
...
class RobotHardwareService (PortableServer.Servant):
    _NP_RepositoryId = _0_OpenHRP.RobotHardwareService._NP_RepositoryId


    _omni_op_d = {"getStatus": _0_OpenHRP.RobotHardwareService._d_getStatus, "power": _0_OpenHRP.RobotHardwareService._d_power, "servo": _0_OpenHRP.RobotHardwareService._d_servo, "calibrateJoint": _0_OpenHRP.RobotHardwareService._d_calibrateJoint, "calibrateSensor": _0_OpenHRP.RobotHardwareService._d_calibrateSensor, "engageProtectiveStop": _0_OpenHRP.RobotHardwareService._d_engageProtectiveStop, "disengageProtectiveStop": _0_OpenHRP.RobotHardwareService._d_disengageProtectiveStop, "getJointPartNames": _0_OpenHRP.RobotHardwareService._d_getJointPartNames, "getJointNamesInPart": _0_OpenHRP.RobotHardwareService._d_getJointNamesInPart}

RobotHardwareService._omni_skeleton = RobotHardwareService
_0_OpenHRP__POA.RobotHardwareService = RobotHardwareService
