...
"""
 @file urgR.py
 @brief capture urg data of right hand
 @date $Date$
...
urgr_spec = ["implementation_id", "urgR", 
		 "type_name",         "urgR", 
		 "description",       "capture urg data of right hand", 
		 "version",           "1.0.0", 
...
# 
# 
class urgR(OpenRTM_aist.DataFlowComponentBase):
...
def urgRInit(manager):
  profile = OpenRTM_aist.Properties(defaults_str=urgr_spec)
...
def MyModuleInit(manager):
  ...
  # Create a component
  comp = manager.createComponent("urgR")
